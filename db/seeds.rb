...
author_book_herbology_henderson = AuthorBook.create!(book_id: herbology.id, author_id: henderson.id)
author_book_herbology_goshawk = AuthorBook.create!(book_id: herbology.id, author_id: goshawk.id)
